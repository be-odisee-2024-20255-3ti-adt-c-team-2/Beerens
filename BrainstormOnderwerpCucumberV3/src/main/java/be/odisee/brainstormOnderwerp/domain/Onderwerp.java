...
public class Onderwerp {
    ...
    public Bijdrage voegBijdrageToe(Deelnemer deelnemer, String type, Bijdrage reactieOp, String tekst)
        ...
        if (type.equals("Idee")) newBijdrage= new Idee(0, "actief", deelnemer, reactieOp, tekst);
        if (type.equals("Reactie")) newBijdrage= reactieOp.voegReactieToe(deelnemer, tekst);
